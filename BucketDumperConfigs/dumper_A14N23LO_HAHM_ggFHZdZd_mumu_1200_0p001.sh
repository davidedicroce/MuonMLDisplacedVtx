...
INPUT_DIR="${PWD}/datasets/group.det-muon.545608.MGPy8EG_A14N23LO_HAHM_ggFHZdZd_mumu_1200_0p001.RDO_MU200.R4-250226.v1_EXT0"
...
WORKDIR="${TestArea:-$PWD}/MuonBucketDump_HAHM_ggFHZdZd_mumu_1200_0p001"
