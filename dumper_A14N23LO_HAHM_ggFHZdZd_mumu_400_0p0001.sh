...
INPUT_DIR="${PWD}/datasets/group.det-muon.545612.MGPy8EG_A14N23LO_HAHM_ggFHZdZd_mumu_400_0p0001.RDO_MU0.R4-250226.v1_EXT0"
...
WORKDIR="${TestArea:-$PWD}/MuonBucketDump_HAHM_ggFHZdZd_mumu_400_0p0001"
