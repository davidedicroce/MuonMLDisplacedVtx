...
INPUT_DIR="${PWD}/datasets/group.det-muon.514997.MGPy8EG_A14N23LO_HNL3_ctau1000_mumumu.RDO_MU0.R4-250226.v1_EXT0"
...
WORKDIR="${TestArea:-$PWD}/MuonBucketDump_HNL3_ctau1000"
